/**
 * Rule-Based Classifier (ported from ClawRouter)
 *
 ...
 * via sigmoid — low confidence yields a null tier (ambiguous).
 *
...
/**
 * Classify a request into a complexity tier using 15 weighted dimensions.
 */
