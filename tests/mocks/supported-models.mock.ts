jest.mock('../../src/supported_models', () => ({
  ...
  getLLMGatewayIdentifier: jest.fn().mockReturnValue(null),
...
export const mockGetLLMGatewayIdentifier = require('../../src/supported_models')
  .getLLMGatewayIdentifier as jest.Mock;
...
export const resetSupportedModelsMocks = () => {
  ...
  mockGetLLMGatewayIdentifier.mockReset().mockReturnValue(null);
