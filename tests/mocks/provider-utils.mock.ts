...
export const mockExtractMediaTypeArrayFromMessages =
  require('../../src/utils/providerAndModelUtils')
    .extractMediaTypeArrayFromMessages as jest.Mock;
export const mockGetSupportedProviderAndModelArray =
  require('../../src/utils/providerAndModelUtils')
    .getSupportedProviderAndModelArray as jest.Mock;
export const mockValidateAndGetProviderAndModel =
  require('../../src/utils/providerAndModelUtils')
    .validateAndGetProviderAndModel as jest.Mock;
...
export const resetProviderUtilsMocks = () => {
  ...
  mockValidateAndGetProviderAndModel
    .mockReset()
    .mockImplementation((model: string) => {
      const [provider, ...modelParts] = model.split('/');
      return { provider, model: modelParts.join('/') };
