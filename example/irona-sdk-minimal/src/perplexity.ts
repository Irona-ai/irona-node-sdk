...
import { CallbackManagerForLLMRun } from "../node_modules/@langchain/core/callbacks/manager";
import { SimpleChatModel } from "../node_modules/@langchain/core/language_models/chat_models";
import { BaseMessage, AIMessage, AIMessageChunk } from "../node_modules/@langchain/core/messages";
import { ChatGenerationChunk } from "../node_modules/@langchain/core/outputs";
...
export class ChatPerplexity extends SimpleChatModel {
  ...
  constructor(chatModelConfig: any) {
