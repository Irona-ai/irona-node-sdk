/**
 * Default scoring configuration for local routing.
 * Ported from ClawRouter's DEFAULT_ROUTING_CONFIG.scoring.
 * Includes multilingual keywords (English, Chinese, Japanese, Russian, German).
 */
...
export const DEFAULT_SCORING_CONFIG: ScoringConfig = {
  ...
  technicalKeywords: [
    ...
    'kubernetes', 'mikroservice', 'datenbank', 'infrastruktur',
  ],
  ...
  domainSpecificKeywords: [
    ...
    'quanten', 'photonik', 'genomik', 'proteomik',
    'topologisch', 'homomorph', 'zero-knowledge', 'gitterbasiert',
  ],

  agenticTaskKeywords: [
    'read file', 'read the file', 'look at', 'check the', 'open the',
    'edit', 'modify', 'update the', 'change the', 'write to', 'create file',
    'run', 'execute', 'test', 'build', 'deploy', 'install', 'npm', 'pip',
    'compile', 'start', 'launch',
    'then', 'after that', 'next', 'and also', 'finally', 'once done',
    'step 1', 'step 2', 'first', 'second', 'lastly',
